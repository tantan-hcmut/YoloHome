...
export function FaceCamera({ onCapture, captureLabel = "Chụp ảnh", disabled = false }: FaceCameraProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="aspect-video overflow-hidden rounded-2xl bg-gray-900 shadow-inner">
        {cameraError ? (
